...
func (s *Streams) GetStreamStatusesByRunState(ctx context.Context, request *shared.ConnectionIDRequestBody) (*operations.GetStreamStatusesByRunStateResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
