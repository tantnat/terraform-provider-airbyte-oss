...
// UpgradeSourceVersion - Upgrade a source to the latest version
func (s *Source) UpgradeSourceVersion(ctx context.Context, request shared.SourceIDRequestBody) (*operations.UpgradeSourceVersionResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/v1/sources/upgrade_version"
	...
	res := &operations.UpgradeSourceVersionResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// ListSourcesForWorkspacePaginated - List sources for workspace
// List sources for workspace. Does not return deleted sources. Paginated.
func (s *Source) ListSourcesForWorkspacePaginated(ctx context.Context, request shared.ListResourcesForWorkspacesRequestBody) (*operations.ListSourcesForWorkspacePaginatedResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/v1/sources/list_paginated"
	...
	res := &operations.ListSourcesForWorkspacePaginatedResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
